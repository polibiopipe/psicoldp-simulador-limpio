...
const SMOKE_TESTS = [
  { message: "Hola, como estas?", expectedAct: "saludo", mustMention: ["puedo conversar"] },
  ...
  { message: "Cuenta, que te trae por aqui?", expectedAct: "motivo_consulta", mustMention: ["cansado"] },
  { message: "Me gustaria conocerte, te parece bien?", expectedAct: "apertura_vinculo", mustMention: ["me parece bien", "puedo ir contandote"] },
  { message: "Cuentame un poco de ti.", expectedAct: "apertura_vinculo" },
  { message: "Me gustaria saber mas de tu historia.", expectedAct: "apertura_vinculo" },
  { message: "Podemos ir con calma.", expectedAct: "apertura_vinculo" },
  { message: "Quiero entender que estas viviendo.", expectedAct: "apertura_vinculo" }
];
