...
export function SimulatedVideoSession({ caseItem, sessionNumber = 1, onFinish }) {
  ...
  return (
    <section className="simulated-video-session" aria-label="Vista de sesión simulada">
      <div className="video-session-status">
        <span><i aria-hidden="true" /> Sesión simulada</span>
      ...
      <p className="video-session-disclaimer">
        Entrevista psicológica formativa · Sin cámara ni video real
      </p>
    </section>
  );
}
