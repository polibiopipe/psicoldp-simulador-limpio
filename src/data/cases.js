...
const catalog = [
  ...
  advancedCase("claudio", "Claudio", "40 años", "Estancamiento vital", "Avanzado", "#13222B", "sensación de estancamiento vital, rutina rígida y dificultad para tomar decisiones.", ["Tiene estabilidad laboral.", "Se siente insatisfecho.", "Analiza mucho antes de actuar."], "Racional, analítico y contenido emocionalmente.", ["Explorar sentido y miedo al cambio.", "Indagar rutina y decisiones.", "Conectar emoción sin forzarla."], ["No empujar cambios impulsivos.", "No ridiculizar cautela.", "No indicar decisiones vitales reales."])
];
